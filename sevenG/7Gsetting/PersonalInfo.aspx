<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SEVENG.Master" AutoEventWireup="true" CodeBehind="PersonalInfo.aspx.cs" Inherits="sevenG._7Gsetting.PersonalInfo" %>
      ...
      <div class="container-fluid">
       ...
       <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> المعلومات الشخصية
        ...
        <div class="card-body">
           ...
           <div class="form-group" background-color: #CEECF5;>
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <label for="paperNametxt">Name</label>
                      ...
                      <div class="col-md-6">
                        <label for="paperNametxt">الاسم </label>
                      ...
                      <div class="col-md-6">
                        <label for="paperNametxt"> Job name</label>
