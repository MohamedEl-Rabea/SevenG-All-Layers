<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SEVENG.Master" AutoEventWireup="true" CodeBehind="BooksPortrait.aspx.cs" Inherits="sevenG.Products.BooksPortrait" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <form class="form-horizontal" runat="server">
      ...
      <div class="container-fluid">
       ...
       <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Portrait Books & Booklets
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                     <label for="ProName">Print Type</label>                          
                        ...
                        <asp:TextBox ID="TxtPages" runat="server" AutoCompleteType="Disabled" AutoPostBack="true" Text="4" OnTextChanged="TxtPages_TextChanged" Class="form-control" aria-describedby="Pages Number" placeholder="عدد الصفحات مضاعفات 4 مثل : 4,8,12,16"></asp:TextBox>
      ...
      Operator="LessThan"  Type="Integer" ValueToCompare="80" ForeColor="Red" SetFocusOnError="True" Enabled="true" />
                  <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" SetFocusOnError="True" ErrorMessage="This field is required" ControlToValidate="TxtPages"></asp:RequiredFieldValidator>
                      --%>
                                </div>
