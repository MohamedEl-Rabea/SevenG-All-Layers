<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SEVENG.Master" AutoEventWireup="true" CodeBehind="Flyers.aspx.cs" Inherits="sevenG.Products.Flyers" %>
        ...
        <div class="card-body">
                ...
                <div class="form-row">
                     ...
                     <div class="col-md-6">
                                <label for="ProName">Product Name</label>                          
                                    <asp:DropDownList ID="DRLProName" runat="server" class="form-control" DataTextField="PROD_NAME" DataValueField="PROD_ID" AutoPostBack="True" OnSelectedIndexChanged="DRLProName_SelectedIndexChanged"></asp:DropDownList>                              
                                </div>
                    <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                     <label for="ProName">Print Type</label>                          
                           ...
                           <div class="col-md-6">
                        <label for="Lamination">Finishing:</label>                          
                                    <asp:DropDownList ID="DrpFinishing" runat="server" class="form-control" DataTextField="FINISHING_TYPE" DataValueField="FINISHING_ID" AutoPostBack="True" OnSelectedIndexChanged="DrpFinishing_SelectedIndexChanged"></asp:DropDownList>                              
                            </div>
          ...
          <div class="table-responsive">
             ...
             <asp:GridView ID="GrdPrices" runat="server"  width="100%" 
                                DataKeyNames="ID" AllowSorting="true" OnSelectedIndexChanged = "GrdPrices_SelectedIndexChanged" OnRowDataBound="GrdPrices_RowDataBound" AutoGenerateColumns="False"  Height="25">
                                <Columns>
